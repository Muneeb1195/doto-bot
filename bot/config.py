...
def load_config():
    ...
    try:
        cfg = {
            ...
            "fe_enabled": settings.get("FINE_ENTRY", "enabled", fallback="True").lower() == "true",
            "fe_m5_ema": int(settings.get("FINE_ENTRY", "m5_ema_period", fallback=20)),
            "fe_pullback_atr": float(settings.get("FINE_ENTRY", "m5_pullback_atr_mult", fallback=0.5)),
            "fe_rsi_min": int(settings.get("FINE_ENTRY", "m5_rsi_min", fallback=40)),
            "fe_rsi_max": int(settings.get("FINE_ENTRY", "m5_rsi_max", fallback=65)),
            "fe_cooldown_bars": int(settings.get("FINE_ENTRY", "m5_cooldown_bars", fallback=12)),
            "fe_breakout_mult": float(settings.get("FINE_ENTRY", "m5_breakout_mult", fallback=1.5)),
